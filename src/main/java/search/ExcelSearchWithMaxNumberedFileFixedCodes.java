...
public class ExcelSearchWithMaxNumberedFileFixedCodes {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    String[] codes = {"13309002002000001", "13306003019000009", "13306002030000003", "13306003015000001","13301010009000004","13306003015000004"};

                    System.out.println(timePart+" 匹配结果：");
                    for (Row row : sheet) {
